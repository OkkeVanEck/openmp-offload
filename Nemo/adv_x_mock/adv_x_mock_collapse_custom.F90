...
MODULE Nemo_Adv_X_Collapse_Custom
    ...
    public :: adv_x_mock_collapse_custom

contains

    SUBROUTINE adv_x_mock_collapse_custom &
...
#ifdef DEBUG_ON
    write (*,*) ""
    write (*,*) "IN: adv_x_mock_collapse_custom"
#endif
...
#ifdef DEBUG_ON
    write (*,*) "OUT: adv_x_mock_collapse_custom"
    write (*,*) ""
#endif
    END SUBROUTINE adv_x_mock_collapse_custom

END MODULE Nemo_Adv_X_Collapse_Custom
