...
MODULE Nemo_Adv_X_Rc_Collapsed_Wrong
    ...
    public :: adv_x_mock_rc_collapsed_wrong

contains

   SUBROUTINE adv_x_mock_rc_collapsed_wrong &
      (jpi, jpj, ncats, &
      pdt, put, pcrh, psm, ps0, psx, psxx, psy , psyy, psxy, e1e2t, tmask)
   !!-----------------------------------------------------------------------------
   !! - Routine: adv_x_mock_rc_collapsed_wrong
   !! - Purpose: Parallelized version called rc with collapse which does not work.
   !!-----------------------------------------------------------------------------
   ...
   !$omp target teams distribute 
    ...
    END SUBROUTINE adv_x_mock_rc_collapsed_wrong

END MODULE Nemo_Adv_X_Rc_Collapsed_Wrong
