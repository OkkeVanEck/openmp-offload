! Implements the data_cat version of adv_x_mock based on adv_x_mock.F90.

MODULE Nemo_Adv_X_Data_Cat
    ...
    public :: adv_x_mock_data_cat

contains 

    SUBROUTINE adv_x_mock_data_cat &
        (jpi, jpj, pdt, put, pcrh, psm, ps0, psx, psxx, psy , psyy, psxy, &
        e1e2t, tmask)
    !!---------------------------------------------------------------------
    !! - Routine: adv_x_mock_data_cat
    !! - Purpose: Adapted version of the parallelized version from the adv_x_mock_data_beta branch
    ...
    write (*,*) ""
#endif
    END SUBROUTINE adv_x_mock_data_cat

END MODULE Nemo_Adv_X_Data_Cat
